...
enum class ColorCode(val hex: Int, val code: String, val description: String) {
    ...
    초록색(Color.parseColor("#00a000"), "CL1006", "그린(초록)"),
    파랑색(Color.parseColor("#0081cc"), "CL1007", "블루(파랑)"),
    갈색(Color.parseColor("#964b00"), "CL1008", "브라운(갈)"),
    보라색(Color.parseColor("#8b00ff"), "CL1009", "바이올렛(보라)"),
    분홍색(Color.parseColor("#ff3399"), "CL1011", "핑크(분홍)"),
