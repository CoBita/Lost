...
enum class ColorCode(val hex: Int, val code: String, val description: String) {
    흰색(Color.parseColor("fff"), "CL1001", "화이트(하양)"),
    검정색(Color.parseColor("000"), "CL1002", "블랙(검정)"),
    빨강색(Color.parseColor("f00"), "CL1003", "레드(빨강)"),
    주황색(Color.parseColor("ff8000"), "CL1004", "오렌지(주황)"),
    노랑색(Color.parseColor("ff0"), "CL1005", "옐로우(노랑)"),
    초록색(Color.parseColor("0f0"), "CL1006", "그린(초록)"),
    파랑색(Color.parseColor("00f"), "CL1007", "블루(파랑)"),
    ...
    기타(Color.parseColor("fff"), "CL1010", "기타");
}